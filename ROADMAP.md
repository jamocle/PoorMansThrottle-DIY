...
2. **Copy Settings Between Locomotives**  
...
6. **Personal Railroad Branding**  
   Allow users to personalize the app with their railroad name, logo, and locomotive naming conventions. This helps operators make the system feel like part of their own railroad and improves identification when running multiple locomotives.
...
8. **Bluetooth Signal Strength Indicator**  
...
12. **Layout Mode vs Portable Mode**  
